...
from .agent.task_spec import SimpleSearchTaskSpec, ComfyUIWorkflowTaskSpec
# Note: Patreon-related imports are in examples/patreon, not main package
# from .agent.task_spec import PatreonCollectionTaskSpec
...
# Patreon command disabled - implementation moved to examples/patreon
# @app.command()
